  ...
  <div class="pad20">
    ...
    <div class="filterbar">
      ...
      <el-form :model="formSearch"
        ...
        <!-- 赛事简称 -->
        <el-form-item label="赛事简称"
                      prop="gameName">
          <el-input type="text"
                     v-model="formSearch.gameName"
                     autocomplete="off"
                     placeholder="赛事简称">
          </el-input>
        </el-form-item>
        ...
        <el-form-item>
           <el-button type="primary"
                           v-if='user.userRole===1'  @click="SendEvent">添加</el-button>
        </el-form-item>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="gameDesc"
                       label="赛事描述">
      </el-table-column>

      <el-table-column prop="gameTime"
                       label="赛事时间">
      </el-table-column>
      ...
      <el-table-column   v-if='user.userRole===1'  label="操作">
        <template slot-scope="scope">
          ...
          <el-button size="mini"
                     type="danger"
                     @click="deleteGame(scope.$index, scope.row,'更新',0)">删除</el-button>
    ...
    <el-dialog title="添加"
        ...
        <el-form :model="formWarn"
                ...
                <el-form-item label="赛事简称"
                              prop="gameName">
                  <el-input v-model.number="formWarn.gameName"
                            placeholder="请输入赛事简称"></el-input>
                </el-form-item>
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   size="small"
                   @click="addGame('formWarn')">确 定</el-button>
      </div>
    </el-dialog>
...
<script>
import * as AJAX from '@/api/comprehensive/game.js'
  ...
  */
   ...
   */
    ...
    addGame(formName) {
          ...
          vm.$refs[formName].validate(valid => {
            if (valid) {
              vm.httpRequst('addGame',formName,'sendFlag','添加成功','添加失败')
            } else {
              return false
            }
          })
