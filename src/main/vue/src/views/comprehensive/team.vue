  ...
  <div class="pad20">
    ...
    <div class="filterbar">
      ...
      <el-form :model="formSearch"
        ...
        <el-form-item>
           <el-button type="primary"  v-if='user.userRole===1'
    ...
    <el-table :data="tableData"
      ...
      <el-table-column   v-if='user.userRole===1'   label="操作">
        <template slot-scope="scope">
          ...
          <el-button size="mini"
                     type="danger"
                     @click="deleteTeam(scope.$index, scope.row,'更新',0)">删除</el-button>
    ...
    <el-dialog title="添加"
        ...
        <el-form :model="formWarn"
                ...
                <el-form-item label="战队名称"
                              prop="teamName">
                  <el-input v-model.number="formWarn.teamName"
                            placeholder="请输入战队名称"></el-input>
                </el-form-item>
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   size="small"
                   @click="addTeam('formWarn')">确 定</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog :title="title"
      ...
      <el-form :model="formWarn"
        ...
        <el-form-item label="战队编码"
                      prop="id">
          <el-input v-model.number="formWarn.id" disabled
                              placeholder="战队编码"></el-input>
        </el-form-item>

        <el-form-item label="战队名称"
                      prop="teamName">
          <el-input v-model.number="formWarn.teamName"
                    placeholder="战队名称"></el-input>
        </el-form-item>
...
<script>
import * as AJAX from '@/api/comprehensive/team.js'
  ...
  */
   ...
   */
    ...
    addTeam(formName) {
          ...
          vm.$refs[formName].validate(valid => {
            if (valid) {
              vm.httpRequst('addTeam',formName,'sendFlag','添加成功','添加失败')
            } else {
              return false
            }
          })
