  ...
  <div class="pad20">
    ...
    <div class="filterbar">
      ...
      <el-form :model="formSearch"
        ...
        <!-- 新闻简称 -->
        <el-form-item label="新闻简称"
                      prop="newsName">
          <el-input type="text"
                     v-model="formSearch.newsName"
                     autocomplete="off"
                     placeholder="新闻简称">
          </el-input>
        </el-form-item>
    ...
    <el-dialog title="添加"
        ...
        <el-form :model="formWarn"
                ...
                <el-form-item label="新闻简称"
                              prop="newsName">
                  <el-input v-model.number="formWarn.newsName"
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   size="small"
                   @click="addNews('formWarn')">确 定</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog :title="title"
      ...
      <el-form :model="formWarn"
        ...
        <el-form-item label="新闻编码"
                      prop="id">
          <el-input v-model.number="formWarn.id" disabled
                              placeholder="新闻编码"></el-input>
        </el-form-item>
...
<script>
import * as AJAX from '@/api/comprehensive/news.js'
  ...
  data() {
    return {
      ...
      formWarn: {
        ...
        newsName: null, // 类型：Number  必有字段  备注：事件类型
        newsDesc: null
      },
      // 当前页码
      currentPage: 4,
  ...
  */
   ...
   */
    ...
    addNews(formName) {
          ...
          vm.$refs[formName].validate(valid => {
            if (valid) {
              vm.httpRequst('addNews',formName,'sendFlag','添加成功','添加失败')
            } else {
              return false
            }
          })
